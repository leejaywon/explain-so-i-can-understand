...
A skill for explaining how existing codebases work in clear, natural language.
...
```text
Use $explain-so-i-can-understand to explain how authentication works in this project.
```

The skill can also be used for a file, component, feature, execution path, data flow, or technical behavior.
